...
//                mSectionsPagerAdapter.notifyDataSetChanged();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.add_klass :
            {
                startActivityForResult(AdditionActivity.fetchIntent(AttendanceMain.this, AdditionActivity.ADDKLASS),0);
                break;
            }
            case R.id.add_lecture :
            {
                startActivityForResult(AdditionActivity.fetchIntent(AttendanceMain.this, AdditionActivity.ADDLECTURE),0);
                break;
            }
